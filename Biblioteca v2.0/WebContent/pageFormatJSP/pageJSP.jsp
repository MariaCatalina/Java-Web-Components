		...
		<nav class="vertical">
			...
			<ul>
				<li><label for="home">Add books</label> <input type="radio"
					...
					<div>
						<ul>
							<li><a href="addDataJSP/AddAuthor.jsp">Add an author</a></li>
							<li><a href="${pageContext.request.contextPath}/AddBook">Add a book</a></li>
						</ul>
					</div></li>
				<li><label for="blog">List of books</label> <input type="radio"
					...
					<div>
						<ul>
							<li><a href="${pageContext.request.contextPath}/ListAuthors">List of authors</a></li>
							<li><a href="${pageContext.request.contextPath}/ListaCarti">List of books</a></li>
							<li><a href="${pageContext.request.contextPath}/ListaCartiImprumutate">Borrowed books</a></li>
					   </ul>
					</div></li>
			</ul>
		</nav>
		...
		<nav class="vertical">
			...
			<ul>
				<li><label for="home">List of books</label> <input type="radio"
					...
					<div>
						<ul>
							<li><a href="${pageContext.request.contextPath}/ListaCartiUser">List all books</a></li>
							<li><a href="${pageContext.request.contextPath}/ListaCartiImprumutateUser">List borrowed books</a></li>
						</ul>
					</div></li>
